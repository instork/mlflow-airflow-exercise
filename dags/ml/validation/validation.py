...
def check_server_maintenance_time(file_loc, exp_name, **kwargs):
    ...
    from mlflow import log_metric, log_param, mlflow
...
def check_stats(file_loc, exp_name, **kwargs):
    ...
    from mlflow import log_metrics, log_param, mlflow
    ...
    adf_stat, adf_pval, adf_usedlag, adf_obs, adf_cvals, adf_icbest = tsa.adfuller(
        ld_series
    )
